...
export function detectCategory(itemName: string): string {
  ...
  if (lower.includes("gobi") || lower.includes("palak") || lower.includes("spinach") || lower.includes("methi") || lower.includes("bhindi") || lower.includes("bindi") || lower.includes("okra") || lower.includes("lady finger") || lower.includes("onion") || lower.includes("tomato") || lower.includes("potato") || lower.includes("chilli") || lower.includes("mirch") || lower.includes("carrot") || lower.includes("beans") || lower.includes("cucumber") || lower.includes("lettuce") || lower.includes("lauki") || lower.includes("ghea") || lower.includes("tori") || lower.includes("thori") || lower.includes("brinjal") || lower.includes("baingan") || lower.includes("eggplant") || lower.includes("badanekaayi") || lower.includes("fruit") || lower.includes("apple") || lower.includes("banana")) {
